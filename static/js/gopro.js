...
{
	if (region.bo.a_ === region.bB.a_)
	{
		return 'on line ' + region.bo.a_;
	}
	return 'on lines ' + region.bo.a_ + ' through ' + region.bB.a_;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.dI, request.P, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {co: fragment, cs: host, cH: path, cJ: port_, cO: protocol, cP: query};
	});
...
var $author$project$Main$SomeAreas = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Geo$pointDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Geo$Point,
	A2($elm$json$Json$Decode$index, 0, $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$index, 1, $elm$json$Json$Decode$float));
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Geo$areaDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Geo$Area,
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'nw', $author$project$Geo$pointDecoder),
	A2($elm$json$Json$Decode$field, 'se', $author$project$Geo$pointDecoder));
...
var $author$project$Geo$inArea = F2(
	function (p, a) {
		return (_Utils_cmp(p.aY, a.bO.aY) < 1) && ((_Utils_cmp(p.aY, a.bR.aY) > -1) && ((_Utils_cmp(p.a$, a.bO.a$) > -1) && (_Utils_cmp(p.a$, a.bR.a$) < 1)));
	});
...
var $author$project$Media$mediaPoint = function (m) {
	return A2(
		$elm$core$Maybe$andThen,
		function (md) {
			var _v0 = _Utils_Tuple2(md.aY, md.a$);
			if ((!_v0.a.$) && (!_v0.b.$)) {
				var lat = _v0.a.a;
				var lon = _v0.b.a;
				return $elm$core$Maybe$Just(
					A2($author$project$Geo$Point, lat, lon));
			} else {
				return $elm$core$Maybe$Nothing;
			}
		},
...
var $author$project$Main$areaFilter = F2(
	function (_v0, m) {
		var model = _v0;
		if ($elm$core$Set$isEmpty(model.aq)) {
			return true;
		} else {
			var areas = A2(
				$elm$core$List$filter,
				function (a) {
					return A2($elm$core$Set$member, a.dL, model.aq);
				},
				model.a9);
			var _v1 = $author$project$Media$mediaPoint(m);
			if (!_v1.$) {
				var p = _v1.a;
				return A2(
					$elm$core$List$any,
					$author$project$Geo$inArea(p),
					areas);
			} else {
				return false;
			}
...
var $author$project$Main$camFilter = F2(
	function (_v0, m) {
		var model = _v0;
		return A2($elm$core$Set$member, m.bw, model.at);
	});
...
var $allo_media$elm_daterange_picker$DateRangePicker$Range$Range = $elm$core$Basics$identity;
...
var $allo_media$elm_daterange_picker$DateRangePicker$Range$create = F3(
	function (zone, begin, end) {
		var _v0 = A2($waratuman$time_extra$Time$Extra$compare, begin, end);
		if (_v0 === 2) {
			return {
				A: end,
				bB: A2($waratuman$time_extra$Time$Extra$endOfDay, zone, begin),
				R: zone
			};
		} else {
			return {
				A: begin,
				bB: A2($waratuman$time_extra$Time$Extra$endOfDay, zone, end),
				R: zone
			};
		}
	});
...
var $allo_media$elm_daterange_picker$DateRangePicker$defaultPredefinedRanges = F2(
	function (zone, today) {
		var daysBefore = F2(
			function (n, posix) {
				return A2(
		...
		return _List_fromArray(
			[
				...
				A3(
					...
					zone,
					A2($waratuman$time_extra$Time$Extra$startOfDay, zone, today),
					A2($waratuman$time_extra$Time$Extra$endOfDay, zone, today))),
				_Utils_Tuple2(
				'Yesterday',
				A3(
					$allo_media$elm_daterange_picker$DateRangePicker$Range$create,
				...
				A3(
					$allo_media$elm_daterange_picker$DateRangePicker$Range$create,
					zone,
					A2($waratuman$time_extra$Time$Extra$startOfMonth, zone, today),
					today)),
				_Utils_Tuple2(
				'Last month',
				A3(
					$allo_media$elm_daterange_picker$DateRangePicker$Range$create,
					zone,
					A2($allo_media$elm_daterange_picker$DateRangePicker$Helpers$startOfPreviousMonth, zone, today),
					A2(
						$waratuman$time_extra$Time$Extra$addMillis,
						-1,
						A2($waratuman$time_extra$Time$Extra$startOfMonth, zone, today))))
...
var $allo_media$elm_daterange_picker$DateRangePicker$defaultConfig = {dh: true, bu: true, bx: '', bI: '', bh: $allo_media$elm_daterange_picker$DateRangePicker$Helpers$monthToString, dN: 'N/A', dU: $allo_media$elm_daterange_picker$DateRangePicker$defaultPredefinedRanges, ac: false, bs: $allo_media$elm_daterange_picker$DateRangePicker$Helpers$weekdayToString, bt: 0, R: $elm$time$Time$utc};
var $elm$core$Set$Set_elm_builtin = $elm$core$Basics$identity;
var $elm$core$Dict$RBEmpty_elm_builtin = {$: -2};
var $elm$core$Dict$empty = $elm$core$Dict$RBEmpty_elm_builtin;
var $elm$core$Set$empty = $elm$core$Dict$empty;
var $allo_media$elm_daterange_picker$DateRangePicker$State = $elm$core$Basics$identity;
...
var $allo_media$elm_daterange_picker$DateRangePicker$Step$Initial = {$: 0};
...
var $waratuman$time_extra$Time$Extra$addDaysZ = F3(
	function (d, z, t) {
		var time = A3(
			$elm$core$Basics$composeR,
			$elm$core$Basics$add(d * 86400000),
		...
		var _v0 = A2($elm$time$Time$toHour, z, time);
		switch (_v0) {
			case 1:
				return A2($waratuman$time_extra$Time$Extra$addHours, -1, time);
			case 23:
				return A2($waratuman$time_extra$Time$Extra$addHours, 1, time);
			default:
				return time;
				...
				return _Utils_Tuple2(
					A2(
						...
						A2(
							...
							1,
							A3(
								$waratuman$time_extra$Time$Extra$addDaysZ,
								-1,
								zone,
...
var $allo_media$elm_daterange_picker$DateRangePicker$init = F2(
	function (config, selected) {
		var _v0 = A3($allo_media$elm_daterange_picker$DateRangePicker$getCalendars, config, selected, $waratuman$time_extra$Time$Extra$epoch);
		var leftCal = _v0.a;
		var rightCal = _v0.b;
		return {
			e: config,
...
var $author$project$Main$typeFilter = F2(
	function (_v0, m) {
		var model = _v0;
		return A2(
			$elm$core$Set$member,
			$author$project$Media$mediaTypeStr(m.bL),
			model.aM);
	});
var $author$project$Main$emptyState = {
	...
	V: _Utils_Tuple2($elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing),
	E: function () {
	...
	bg: false,
	aG: $author$project$ScreenOverlay$initOverlay,
	c3: $pablen$toasty$Toasty$initialState,
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{dg: false, b9: r.b9, ax: r.ax, cq: r.cq, dI: r.dI, d7: r.d7, c4: r.c4, P: r.P}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{b9: $elm$http$Http$emptyBody, ax: r.ax, cq: _List_Nil, dI: 'GET', d7: $elm$core$Maybe$Nothing, c4: $elm$core$Maybe$Nothing, P: r.P});
};
										...
										return function (width) {
											return function (height) {
												return function (metaData) {
													return {bw: camera_model, K: captured_at, $7: created_at, bD: file_size, bF: height, ah: id, bL: media_type, dH: metaData, cC: moments_count, dW: ready_to_view, bT: source_duration, d9: token, b_: width};
												};
											};
										};
									};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {cf: col, dn: contextStack, cL: problem, cW: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.cW, s.cf, x, s.g));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{cf: col, g: s0.g, h: s0.h, b: offset, cW: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.cW, s.cf, s);
	};
};
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{cf: 1, g: s.g, h: s.h, b: s.b + 1, cW: s.cW + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{cf: s.cf + 1, g: s.g, h: s.h, b: newOffset, cW: s.cW, a: s.a}));
		};
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.cW, s.cf, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{cf: newCol, g: s.g, h: s.h, b: newOffset, cW: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {cf: col, cL: problem, cW: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.cW, p.cf, p.cL);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{cf: 1, g: _List_Nil, h: 1, b: 0, cW: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Media$MetaData = F9(
	function (cam, ts, lat, lon, maxSpeed2d, maxSpeed3d, maxFaces, scene, sceneProb) {
		return {dk: cam, aY: lat, a$: lon, dD: maxFaces, dE: maxSpeed2d, dF: maxSpeed3d, dZ: scene, d_: sceneProb, ea: ts};
	});
...
var $author$project$Media$Beach = 5;
var $author$project$Media$Indoor = 2;
var $author$project$Media$Snow = 0;
var $author$project$Media$UnknownLocation = 6;
var $author$project$Media$Urban = 1;
var $author$project$Media$Vegetation = 4;
var $author$project$Media$Water = 3;
var $author$project$Media$strLocation = function (l) {
	switch (l) {
		case 'Snow':
			return 0;
		case 'Urban':
...
var $author$project$Media$metaDataDecoder = A3(
	...
	A3(
		...
		$elm$json$Json$Decode$nullable(
			A2($elm$json$Json$Decode$map, $author$project$Media$strLocation, $elm$json$Json$Decode$string)),
		A3(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'maxFaces',
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {cN: processes, c0: taggers};
	});
		...
		switch (msg.$) {
			...
			case 2:
				return _Utils_update(
					...
					{
						H: false,
						s: $allo_media$elm_daterange_picker$DateRangePicker$Step$fromMaybe(internal.V)
					});
			case 3:
				var posix = msg.a;
				return _Utils_update(
			...
			case 4:
				return _Utils_update(
					...
					{
						F: rightCal,
						C: A2($allo_media$elm_daterange_picker$DateRangePicker$Helpers$startOfNextMonth, internal.e.R, rightCal)
					});
			case 5:
				return internal;
			case 6:
				var _v3 = A3($allo_media$elm_daterange_picker$DateRangePicker$getCalendars, internal.e, internal.V, internal.D);
			...
			case 8:
				...
				return _Utils_update(
					internal,
					{
						s: A3($allo_media$elm_daterange_picker$DateRangePicker$Step$next, internal.e.R, picked, step)
					});
			case 7:
				return _Utils_update(
					internal,
					{
						F: A2($allo_media$elm_daterange_picker$DateRangePicker$Helpers$startOfPreviousMonth, internal.e.R, leftCal),
						C: leftCal
					});
			default:
				var dateRange = msg.a;
...
var $allo_media$elm_daterange_picker$DateRangePicker$subscriptions = F2(
	function (toMsg, _v0) {
		var internal = _v0;
		return (internal.H && (!internal.e.ac)) ? $elm$browser$Browser$Events$onMouseUp(
...
var $author$project$Main$DLOpt = F5(
	function (url, name, desc, width, height) {
		return {ch: desc, bF: height, dL: name, P: url, b_: width};
	});
...
var $author$project$Main$dloptsDecoder = A2(
	$elm$json$Json$Decode$map,
	function (opts) {
		var ixd = $elm$core$Dict$fromList(
			A2(
				$elm$core$List$map,
				function (d) {
					return _Utils_Tuple2(d.dL, d);
				},
				opts));
		return A2(
			$author$project$Main$DLOpts,
			A2($elm$core$Dict$get, 'mp4_low', ixd),
			opts);
	},
...
var $author$project$Main$startOfYear = function (zone) {
	return A2(
		$elm$core$Basics$composeR,
		A2($waratuman$time_extra$Time$Extra$setMonth, zone, 0),
		$waratuman$time_extra$Time$Extra$startOfMonth(zone));
};
var $author$project$Main$startOfPreviousYear = function (zone) {
	return A2(
		$elm$core$Basics$composeR,
		A2($waratuman$time_extra$Time$Extra$setMonth, zone, 0),
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$waratuman$time_extra$Time$Extra$addMillis(-1),
				$author$project$Main$startOfYear(zone))));
};
var $author$project$Main$myRanges = F2(
	function (zone, today) {
		var daysBefore = F2(
			function (n, posix) {
				return A2(
		...
		return _List_fromArray(
			[
				...
				A3(
					$allo_media$elm_daterange_picker$DateRangePicker$Range$create,
					zone,
					A2($author$project$Main$startOfPreviousMonth, zone, today),
					A2(
						$waratuman$time_extra$Time$Extra$addMillis,
						-1,
						A2($waratuman$time_extra$Time$Extra$startOfMonth, zone, today)))),
				...
				A3(
					$allo_media$elm_daterange_picker$DateRangePicker$Range$create,
					zone,
					A2($author$project$Main$startOfYear, zone, today),
					today)),
				_Utils_Tuple2(
				'Last year',
				A3(
					$allo_media$elm_daterange_picker$DateRangePicker$Range$create,
					zone,
					A2($author$project$Main$startOfPreviousYear, zone, today),
					A2($author$project$Main$startOfYear, zone, today)))
			]);
	});
...
var $allo_media$elm_daterange_picker$DateRangePicker$setToday = F2(
	function (today, _v0) {
		var internal = _v0;
		var _v1 = A3($allo_media$elm_daterange_picker$DateRangePicker$getCalendars, internal.e, internal.V, today);
		var newLeftCal = _v1.a;
		var newRightCal = _v1.b;
		return _Utils_update(
			internal,
...
var $allo_media$elm_daterange_picker$DateRangePicker$now = F2(
	function (toMsg, _v0) {
		...
		return A2(
			...
			toMsg,
			A2($allo_media$elm_daterange_picker$DateRangePicker$nowTask, internal.e, internal.V));
	});
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{b9: r.b9, ax: r.ax, cq: _List_Nil, dI: 'POST', d7: $elm$core$Maybe$Nothing, c4: $elm$core$Maybe$Nothing, P: r.P});
};
...
var $author$project$Main$addToast = F2(
	function (toast, _v0) {
		...
		var _v1 = A4(
			...
			$author$project$Main$toastConfig,
...
var $author$project$Main$toastX = F3(
	function (f, m, t) {
		return $author$project$Main$addToast(
			A2(f, m, t));
	});
var $author$project$Main$toastError = $author$project$Main$toastX($pablen$toasty$Toasty$Defaults$Error);
			...
			case 1:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							c3: A2($pablen$toasty$Toasty$Stack, newStack, seed)
						}),
		...
		switch (msg.$) {
			...
			case 4:
				...
				return _Utils_Tuple2(
					model,
					function () {
						var sevenDays = A2($waratuman$time_extra$Time$Extra$addDays, -7, t);
						var recond = A2(
							$allo_media$elm_daterange_picker$DateRangePicker$reconfigure,
							function (c) {
								return _Utils_update(
									c,
									{dU: $author$project$Main$myRanges});
							},
							model.E);
						var rangedPicker = A2(
							$allo_media$elm_daterange_picker$DateRangePicker$setRange,
							$elm$core$Maybe$Just(
								A3($allo_media$elm_daterange_picker$DateRangePicker$Range$create, model.R, sevenDays, t)),
							recond);
					...
					_Utils_update(
						model,
						{
							V: _Utils_Tuple2(
								...
								$elm$core$Maybe$Nothing),
							aG: $author$project$ScreenOverlay$show(model.aG)
						}),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								...
								$elm$http$Http$get(
								{
									ax: A2($elm$http$Http$expectJson, $author$project$Main$SomeDLOpts, $author$project$Main$dloptsDecoder),
									P: '/api/retrieve2/' + m.ah
								})
							])));
			case 8:
				var mid = msg.a;
					...
					$elm$http$Http$post(
						{
							...
							ax: $elm$http$Http$expectWhatever(
			...
			case 11:
				...
				if (!result.$) {
					...
					return A3(
						...
						'Reauth failure',
						$author$project$Formats$httpErr(x),
						_Utils_Tuple2(model, $elm$core$Platform$Cmd$none));
				}
			case 10:
				var _v9 = msg.a;
			...
			case 12:
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							V: _Utils_Tuple2($elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing),
							aG: $author$project$ScreenOverlay$hide(model.aG)
						}),
				...
				return _Utils_Tuple2(
					$author$project$Main$filter(
						_Utils_update(
							model,
							{
								aM: A3($author$project$Main$addOrRemove, checked, t, model.aM)
							})),
					$elm$core$Platform$Cmd$none);
			case 16:
				var t = msg.a;
			...
			default:
				...
				var et = A2($waratuman$time_extra$Time$Extra$fromIso8601Date, model.R, e);
				...
				var nst = function () {
					...
					if ((!_v11.a.$) && (!_v11.b.$)) {
						...
						return A2(
							$allo_media$elm_daterange_picker$DateRangePicker$setRange,
							$elm$core$Maybe$Just(
								A3($allo_media$elm_daterange_picker$DateRangePicker$Range$create, model.R, l, h)),
							model.E);
					} else {
						return model.E;
					}
...
var $author$project$Main$BackendCmd = function (a) {
	return {$: 10, a: a};
};
...
var $author$project$Main$CloseOverlay = {$: 12};
...
var $basti1302$elm_human_readable_filesize$Filesize$defaultSettings = {bz: 2, bb: '.', a5: 0};
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {dy: index, dC: match, dO: number, d5: submatches};
	});
...
var $basti1302$elm_human_readable_filesize$Filesize$roundToDecimalPlaces = F2(
	function (settings, num) {
		var rounded = A2($myrho$elm_round$Round$floor, settings.bz, num);
		...
		return (settings.bb === '.') ? withoutTrailingDot : A4(
			$elm$regex$Regex$replaceAtMost,
			1,
...
var $basti1302$elm_human_readable_filesize$Filesize$formatWithSplit = F2(
	function (settings, num) {
		if (!num) {
			...
			var unitDefinitionList = $basti1302$elm_human_readable_filesize$Filesize$getUnitDefinitionList(settings.a5);
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$src('/thumb/' + m.ah)
						]),
					_List_Nil),
					function () {
					var _v0 = m.bT;
...
var $rtfeldman$elm_css$Css$relative = {a0: 0, Q: 'relative'};
...
var $rtfeldman$elm_css$Css$zero = {aZ: 0, aC: 0, Z: 0, aD: 0, aE: 0, ai: 0, aj: 0, dO: 0, _: 0, bk: 0, aN: '', a5: 0, Q: '0'};
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.dp) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.dL, record.dp, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	...
	return {ce: charset, dq: finalDeclarations, ct: imports, cE: namespaces};
};
...
var $Skinney$murmur3$Murmur3$finalize = function (data) {
	var acc = (!(!data.aB)) ? (data.am ^ A2(
		...
		A2(
			...
			15,
			A2($Skinney$murmur3$Murmur3$multiplyBy, $Skinney$murmur3$Murmur3$c1, data.aB)))) : data.am;
	var h0 = acc ^ data.au;
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {ce: charset, dq: declarations, ct: imports, cE: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {ce: $elm$core$Maybe$Nothing, ct: _List_Nil, cE: _List_Nil, cZ: snippets};
};
...
var $rtfeldman$elm_css$Css$fixed = {aR: 0, a0: 0, bp: 0, Q: 'fixed'};
...
var $rtfeldman$elm_css$Css$transparent = {L: 0, Q: 'transparent'};
...
var $rtfeldman$elm_css$Css$auto = {df: 0, c: 0, ay: 0, be: 0, dB: 0, aC: 0, Z: 0, M: 0, aF: 0, I: 0, bp: 0, aL: 0, z: 0, Q: 'auto'};
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$width(v.b_),
						$elm$html$Html$Attributes$height(v.bF)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src(v.P),
...
var $author$project$Main$renderMetaData = function (g) {
	return _Utils_ap(
		function () {
			var _v0 = _Utils_Tuple2(g.aY, g.a$);
			if ((!_v0.a.$) && (!_v0.b.$)) {
				var lat = _v0.a.a;
				var lon = _v0.b.a;
				return _List_fromArray(
						...
						_List_fromArray(
							[
								...
								' with probability ' + $elm$core$String$fromFloat(
									A2($elm$core$Maybe$withDefault, 0, g.d_)))
							]))
					]);
			}
		}());
...
var $author$project$Main$renderOverlay = F2(
	function (z, _v0) {
		...
		var mdls = _v0.b;
		if (mm.$ === 1) {
			return $elm$html$Html$text('nothing to see here');
		} else {
			var m = mm.a;
			return A2(
				$elm$html$Html$div,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick(
									$author$project$Main$RefreshMedium(m.ah))
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('Refresh Data from GoPro')
								])),
							A2($author$project$Main$renderIcon, m, mdls),
							A2(
							$elm$html$Html$dl,
							_List_fromArray(
								[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												$elm$core$String$fromInt(m.b_) + ('x' + $elm$core$String$fromInt(m.bF)))
											])),
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$title(
												$author$project$Formats$comma(m.bD))
											]),
										_List_fromArray(
											[
												$elm$html$Html$text(
												$basti1302$elm_human_readable_filesize$Filesize$format(m.bD))
											])),
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												$author$project$Media$readyTypeStr(m.dW))
											]))
									]),
								_Utils_ap(
									function () {
														...
														_List_fromArray(
															[
																...
																$author$project$Formats$millis(
																	A2($elm$core$Maybe$withDefault, 0, m.bT)))
															]))
													]);
											}
										}
													...
													return A2(
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$elm$html$Html$Attributes$href(d.P),
																		$elm$html$Html$Attributes$title(d.ch)
																	]),
																_List_fromArray(
																	[
...
var $allo_media$elm_daterange_picker$DateRangePicker$Open = {$: 6};
...
var $allo_media$elm_daterange_picker$DateRangePicker$Clear = {$: 1};
var $allo_media$elm_daterange_picker$DateRangePicker$Hover = function (a) {
	return {$: 3, a: a};
};
var $allo_media$elm_daterange_picker$DateRangePicker$Next = {$: 4};
var $allo_media$elm_daterange_picker$DateRangePicker$NoOp = {$: 5};
var $allo_media$elm_daterange_picker$DateRangePicker$Pick = function (a) {
	return {$: 8, a: a};
};
var $allo_media$elm_daterange_picker$DateRangePicker$Prev = {$: 7};
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						config.bu ? $elm$html$Html$Events$onClick(
						A3(
			...
			_List_fromArray(
				[
					...
					A2(
						$elm$core$List$map,
						entry,
						A2(internal.e.dU, config.R, today)))
				]));
	});
...
var $allo_media$elm_daterange_picker$DateRangePicker$Calendar$inRangePath = F4(
	function (zone, maybeHovered, begin, day) {
		if (!maybeHovered.$) {
			var hovered = maybeHovered.a;
			return A2(
				$allo_media$elm_daterange_picker$DateRangePicker$Range$between,
				day,
				A3($allo_media$elm_daterange_picker$DateRangePicker$Range$create, zone, begin, hovered));
		} else {
			return false;
		}
	});
...
var $allo_media$elm_daterange_picker$DateRangePicker$Calendar$dayCell = F2(
	function (_v0, day) {
		...
		var base = {a7: false, bB: false, bG: false, bH: false, bo: false};
		var _v1 = function () {
			switch (step.$) {
				case 0:
					return base;
				case 1:
					...
					return _Utils_update(
						base,
						{
							a7: A3($allo_media$elm_daterange_picker$DateRangePicker$Helpers$sameDay, zone, begin, day),
							bG: A4($allo_media$elm_daterange_picker$DateRangePicker$Calendar$inRangePath, zone, hovered, begin, day),
							bo: A3($allo_media$elm_daterange_picker$DateRangePicker$Helpers$sameDay, zone, begin, day)
						});
				default:
					var range = step.a;
					return _Utils_update(
						base,
						{
							...
							bB: A3(
								...
								day,
								$allo_media$elm_daterange_picker$DateRangePicker$Range$endsAt(range)),
							bH: A2($allo_media$elm_daterange_picker$DateRangePicker$Range$between, day, range),
							bo: A3(
								$allo_media$elm_daterange_picker$DateRangePicker$Helpers$sameDay,
								zone,
								day,
		...
		return A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								A3($allo_media$elm_daterange_picker$DateRangePicker$Helpers$sameDay, zone, day, today)),
								...
								!_Utils_eq(
									A2($elm$time$Time$toMonth, zone, target),
									A2($elm$time$Time$toMonth, zone, day)))
							])),
						$elm$html$Html$Events$onMouseOver(
						hover(day)),
						$elm$html$Html$Attributes$title(
						A2($allo_media$elm_daterange_picker$DateRangePicker$Helpers$formatDate, zone, day))
					]),
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					$elm$core$String$fromInt(
						A2($elm$time$Time$toDay, zone, day)))
				]));
	});
...
var $allo_media$elm_daterange_picker$DateRangePicker$Calendar$fromPosix = F3(
	function (zone, weeksStartOn, posix) {
		var base = A2($waratuman$time_extra$Time$Extra$startOfDay, zone, posix);
		return A2(
			$elm$core$List$take,
			6,
			A2(
				...
				A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$elm$time$Time$toWeekday(zone),
						$elm$core$Basics$neq(weeksStartOn)),
					A2(
						$elm$core$List$map,
						function (v) {
							return A3($waratuman$time_extra$Time$Extra$addDaysZ, v, zone, base);
						},
...
var $allo_media$elm_daterange_picker$DateRangePicker$Calendar$view = function (config) {
	var next = config.cF;
	var prev = config.cK;
	var target = config.bV;
	var weeksStartOn = config.bt;
	var weekdayFormatter = config.bs;
				...
				_List_fromArray(
					[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												A3($allo_media$elm_daterange_picker$DateRangePicker$Helpers$shortMonth, zone, monthFormatter, target))
											])),
						...
						A2(
							...
							A3($allo_media$elm_daterange_picker$DateRangePicker$Calendar$fromPosix, zone, weeksStartOn, target)))
					]))
			]));
};
var $allo_media$elm_daterange_picker$DateRangePicker$panel = F2(
	function (toMsg, _v0) {
		...
		var baseCalendar = {
			...
			dM: A3($allo_media$elm_daterange_picker$DateRangePicker$handleEvent, toMsg, $allo_media$elm_daterange_picker$DateRangePicker$NoOp, internal),
			dS: function (posix) {
				return A3(
					$allo_media$elm_daterange_picker$DateRangePicker$handleEvent,
					toMsg,
		...
		var allowNext = internal.e.dh || (_Utils_cmp(
			$elm$time$Time$posixToMillis(
				A2($waratuman$time_extra$Time$Extra$startOfMonth, internal.e.R, internal.C)),
			$elm$time$Time$posixToMillis(
				A2($waratuman$time_extra$Time$Extra$startOfMonth, internal.e.R, internal.D))) < 0);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
								...
								[
									...
									switch (_v1.$) {
										...
										default:
											var range = _v1.a;
											return $elm$html$Html$text(
												A2($allo_media$elm_daterange_picker$DateRangePicker$Range$format, internal.e.R, range));
									}
								}()
								])),
							A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$String$trim('EDRP ' + internal.e.bx))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$class(
							$elm$core$String$trim('EDRP__input ' + internal.e.bI)),
							$elm$html$Html$Attributes$disabled(internal.aT),
							...
							A2(
								...
								A2(
									$elm$core$Maybe$map,
									$allo_media$elm_daterange_picker$DateRangePicker$Range$format(internal.e.R),
									internal.V))),
							$elm$html$Html$Events$onClick(
					...
					_List_Nil),
					(internal.e.ac || internal.H) ? A2($allo_media$elm_daterange_picker$DateRangePicker$panel, toMsg, internal) : $elm$html$Html$text('')
				]));
	});
				...
				[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Events$onClick(
											$author$project$Main$BackendCmd(0))
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('🔒')
									...
									A5($author$project$Main$aList, model.at, ms.cc, 'cameras', $elm$core$Basics$identity, $author$project$Main$CheckedCam),
									A5($author$project$Main$aList, model.aM, ms.c8, 'types', $elm$core$Basics$identity, $author$project$Main$CheckedType),
									A2(
									$elm$html$Html$div,
									_List_Nil,
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$for('momentsOnly')
												]),
											_List_fromArray(
												[
													$elm$html$Html$text('Moments Only')
												]))
										]))
								]))
						])),
					...
					_List_fromArray(
						[
							...
							A2($author$project$Main$renderOverlay, z, model.V))
						])),
					A4($pablen$toasty$Toasty$view, $author$project$Main$toastConfig, $pablen$toasty$Toasty$Defaults$view, $author$project$Main$ToastyMsg, model.c3),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
...
var $author$project$Main$view = function (_v0) {
	...
	if (_v1.$ === 1) {
		...
		if (_v2.$ === 1) {
			...
			var m = _v2.a;
			return A2($author$project$Main$renderMediaList, m, model);
		}
	} else {
		var x = _v1.a;
		return A2(
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{dz: $author$project$Main$init, d6: $author$project$Main$subscriptions, eb: $author$project$Main$update, ed: $author$project$Main$view});
